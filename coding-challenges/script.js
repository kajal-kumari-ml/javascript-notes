...
*/
const bill=40;
const tip=(bill>=50 || bill<=300)?console.log(`The bill was${bill} value, the tip, and the final value ${bill+bill*0.15}`):console.log(`The bill was${bill} value, the tip, and the final value ${bill+bill*0.2}`);
